...
export default function ProductsProvider({ children }) {
  const [products, setProducts] = useState([
    {
      nombre: "Camera",
      descripcion: "camara profecional etc.",
      src: camara,
      cantidad: 4,
      id: 1,
    },
  ...
  return (
    <ProductContex.Provider value={{ products, productsCarr, agregar, eliminar, setProducts }}>
      {children}
